...
public class GitHubClient {
  ...
  public List<Item> search(double lat, double lon, String keyword) {
    ...
    ResponseHandler<List<Item>> responseHandler =
        new ResponseHandler<List<Item>>() {
          @Override
          public List<Item> handleResponse(HttpResponse httpResponse) throws IOException {
    ...
    for (int i = 0; i < array.length(); i++) {
      ...
      Item item =
          Item.ItemBuilder.anItem()
              .withItemId(getStringFieldOrEmpty(object, "id"))
              .withName(getStringFieldOrEmpty(object, "title"))
